...
def get_first_date_of_this_month(
    base_date: date,
) -> date:
    """
    今月初日取得
    ...
    base_date_by_month_day: date = base_date_by_month.replace(day=1)

    return base_date_by_month_day


def get_last_date_of_this_month(
    base_date: date,
) -> date:
    """
    今月末日取得
...
def get_last_date_of_next_month(
    base_date: date,
) -> date:
    """
    来月末日取得
